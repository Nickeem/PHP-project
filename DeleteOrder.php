...
if (isset($_SESSION['DAlert'])) {
  echo $_SESSION['DAlert'];
  unset($_SESSION['DAlert']);
}
			...
			<a href="#" class="navicon"></a>
				<div class="toggle">
					<ul class="toggle-menu">
						...
						<li><a class="active" href="DeleteOrder.php">Delete Orders</a></li>
...
<!--content-->
	<div class="contact">
		...
		<div class="menu-top">
			...
			<h5> Chose Which Order to Remove</h5>
        ...
        <div class="grid-contact">
          <div class="col-md-6 contact-grid">
            ...
            <div class="box">
              ...
              $result = mysqli_query($conn, "SELECT OrderNum FROM orders WHERE userID = '$UserID'");
